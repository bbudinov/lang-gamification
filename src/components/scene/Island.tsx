...
const ISLAND_VISUALS: Record<string, IslandVisual> = {
  ...
  numbers:  { scale: 1.05, height: 1.1, groundColor: "#0ea5e9", cliffColor: "#0369a1", beachColor: "#fde68a", decoration: "rocks",    satellites: 1 },
  family:   { scale: 1.3,  height: 1.0, groundColor: "#ea580c", cliffColor: "#92400e", beachColor: "#fde68a", decoration: "house",    satellites: 2 },
  body:     { scale: 0.85, height: 0.7, groundColor: "#14b8a6", cliffColor: "#0f766e", beachColor: "#a8d8ea", decoration: "rocks",    satellites: 0 },
  ...
  work:     { scale: 0.9,  height: 0.8, groundColor: "#6366f1", cliffColor: "#4338ca", beachColor: "#e0e7ff", decoration: "rocks",    satellites: 0 },
