...
export const npcs: NPCData[] = [
  ...
  },
  {
    ...
    goal: {
      ...
      it: "Aiutare il bambino a trovare il suo materiale scolastico preferito",
      de: "Dem Kind helfen, seine Lieblings-Schulsachen zu finden",
      fr: "Aider l'enfant à trouver ses fournitures scolaires préférées",
    },
    greeting: {
      ...
      it: "Benvenuto in biblioteca! 📚 Sono la Signorina Luna. Shhh... sussurra per favore! Di cosa hai bisogno per la scuola oggi?",
      de: "Willkommen in der Bibliothek! 📚 Ich bin Fräulein Luna. Psst... flüster bitte! Was brauchst du heute für die Schule?",
      fr: "Bienvenue à la bibliothèque ! 📚 Je suis Mademoiselle Luna. Chut... chuchote s'il te plaît ! De quoi as-tu besoin pour l'école aujourd'hui ?",
    },
