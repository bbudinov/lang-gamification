...
export const WORLDS: World[] = [
  ...
  },
  {
    ...
    emoji: "🏟️",
    description: { en: "Compete in the arena!", bg: "Състезавай се на арената!", es: "¡Compite en la arena!", it: "Competi nell'arena!", de: "Tritt in der Arena an!", fr: "Fais la compétition dans l'arène !" },
    requiredXP: 11000,
    themeColor: "#22c55e",
    bgColor: "#0a1a0a",
    topicIds: ["sports-stadium", "sports-basketball", "sports-tennis", "sports-racing", "sports-boxing"],
  },
  {
    id: "history-bg",
    name: { en: "Bulgarian History", bg: "Българска история", es: "Historia Búlgara", it: "Storia Bulgara", de: "Bulgarische Geschichte", fr: "Histoire Bulgare" },
    emoji: "🇧🇬",
    description: { en: "Discover Bulgaria's past!", bg: "Открий миналото на България!", es: "¡Descubre el pasado de Bulgaria!", it: "Scopri il passato della Bulgaria!", de: "Entdecke Bulgariens Vergangenheit!", fr: "Découvre le passé de la Bulgarie !" },
    requiredXP: 11500,
    themeColor: "#b45309",
    bgColor: "#1a1408",
    topicIds: ["history-bg-ancient", "history-bg-medieval", "history-bg-monastery", "history-bg-revival", "history-bg-modern"],
  },
  {
    id: "professions",
    name: { en: "Professions", bg: "Професии", es: "Profesiones", it: "Professioni", de: "Berufe", fr: "Professions" },
    emoji: "👨‍⚕️",
    description: { en: "Explore career paths!", bg: "Разгледай кариерните пътища!", es: "¡Explora carreras profesionales!", it: "Esplora i percorsi di carriera!", de: "Erkunde Karrierewege!", fr: "Explore les carrières !" },
    requiredXP: 12000,
    themeColor: "#0ea5e9",
    bgColor: "#0a1a2e",
    topicIds: ["prof-hub", "prof-doctor", "prof-teacher", "prof-chef", "prof-pilot", "prof-engineer"],
  },
  {
    id: "body-health",
    name: { en: "Body & Health", bg: "Тяло и здраве", es: "Cuerpo y Salud", it: "Corpo e Salute", de: "Körper & Gesundheit", fr: "Corps & Santé" },
    emoji: "🧬",
    description: { en: "Learn how your body works!", bg: "Научи как работи тялото ти!", es: "¡Aprende cómo funciona tu cuerpo!", it: "Scopri come funziona il tuo corpo!", de: "Lerne wie dein Körper funktioniert!", fr: "Apprends comment ton corps fonctionne !" },
    requiredXP: 12500,
    themeColor: "#ef4444",
    bgColor: "#1a0a0a",
    topicIds: ["body-heart", "body-brain", "body-lungs", "body-bones", "body-muscles", "body-lab"],
  },
];
