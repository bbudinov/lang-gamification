...
const RULES_BG = [
  ...
  { id: "rules-memorymix-bg", text: "Мемори Микс. Специално предизвикателство! Думи от различни острови са смесени в една игра. Отключва се след Мемори Мач на поне 2 острова. Колкото повече играеш, толкова повече карти получаваш!", lang: "bg" },
...
const RULES_EN = [
  ...
  { id: "rules-memorymix-en", text: "Memory Mix. A special challenge! Words from different islands are mixed together in one game. You unlock it after completing Memory Match on at least 2 islands. The more you play, the more cards you get!", lang: "en" },
